...
// Change to void
std::string Simulation::event_injury(int serious_injury = 0,
...
// Change to void
std::string Simulation::event_penalty(int attackers_effectivity = 0,
...
// Change to void
std::string Simulation::event_cornerkick(int attackers_effectivity = 0,
...
// Change to void
std::string Simulation::event_shotongoal(int attackers_effectivity = 0,
                                         int deffenders_effectivity = 0,
                                         int goalkeepers_effectivity = 0)
{
  int A_Number = attackers_effectivity + 500;
...
// Change to void
std::string Simulation::event_attempt(int attackers_effectivity = 0,
                                      int deffenders_effectivity = 0,
                                      int goalkeepers_effectivity = 0)
{ 
  int A_Number = attackers_effectivity + 500;
...
bool Simulation::matchopportunity_mechanics(int playerA_possesion, int playerB_possesion)
{
